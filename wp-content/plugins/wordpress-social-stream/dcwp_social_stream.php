...
class dc_jqsocialstream {
	...
	function __construct() {
		...
		add_shortcode('dc_social_feed_events', 'dc_social_feed_events_shortcode');
	...
	function add_dcwss_scripts() {
		...
		wp_enqueue_script( 'dcwss', plugins_url() . '/wordpress-social-stream/js/jquery.social.stream.1.5.15.min.js' );

	// load footer	
	//	wp_enqueue_script( 'dcwss-wall', dc_jqsocialstream::get_plugin_directory() . '/js/jquery.social.stream.wall.1.6.js', array(), '', true );
	//	wp_enqueue_script( 'dcwss', dc_jqsocialstream::get_plugin_directory() . '/js/jquery.social.stream.1.5.15.min.js', array(), '', true );
